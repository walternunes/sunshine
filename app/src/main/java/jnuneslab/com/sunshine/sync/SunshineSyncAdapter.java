package jnuneslab.com.sunshine.sync;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            ...
            //Log.e(LOG_TAG, "API URL" + builtUri);
        ...
        if (displayNotifications) {
            ...
            if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    // Create NotificationCompatBuilder
                    ...
                    // Open App when click in the notification
                    Intent resultIntent = new Intent(context, MainActivity.class);

                    // Create the stackbuild to ensures that navigating backward from the Activity leads out the application
    ...
    public static Account getSyncAccount(Context context) {
         ...
         */
            ...
            /*
             * If not set android:syncable="true" in
